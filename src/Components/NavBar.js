    ...
    <> 
      <div className='flex min-h-fit bg-gray-300'>
        ...
        <div className='relative ml-auto pr-11'>
          ...
          <div className="block px-4 py-2 text-sm maintext hover:bg-gray-300" role="menuitem" tabindex="-1" id="menu-item-0">Project Lookup</div>
          <div className="block px-4 py-2 text-sm maintext hover:bg-gray-300" role="menuitem" tabindex="-1" id="menu-item-1">About</div>          
          </div>
          </div>
